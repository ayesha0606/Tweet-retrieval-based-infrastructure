...
<table width="642" align="left"  cellpadding="0" cellspacing="0"  >
	...
	while(rs2.next())
	{
		...
		%>
				...
				<tr>
				  <td  width="109" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6">User Image </div></td>
				  <td  width="97" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6">Username</div></td>
				  <td   width="206" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6">E-mail</div></td>
				  <td  width="126" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6">Phone Number</div></td>
			      <td  width="102" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6">Details</div></td>
				</tr>
					<%}%>
				<tr>
						
	   	<td width="109"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=i%>&type=<%="user"%>"/></td>
			  <td  width="97" height="110" align="center" valign="middle" ><div align="center"><%out.println(s1);%></div></td>	
			  ...
			  <td  width="102" height="110" align="center" valign="middle"><div align="center"><a href="userdetails2.jsp?id=<%=i%>">view more</a></div></td>
		</tr>
