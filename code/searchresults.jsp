    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="article">
            <p align="justify"></p>
<table width="342" align="left"  cellpadding="0" cellspacing="0"  >
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		<%
			...
			<tr>
             ...
             <tr> <td width="50" height="65" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7">Name</div></td>
