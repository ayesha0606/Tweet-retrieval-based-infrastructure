...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style4">  Tweet Lining Words and Used Hash Words </h2>
          <div class="img"></div>
          <div class="article">
            <p align="justify"> 
	...
	while ( rs.next() )
	{
		...
		%>
			...
			<tr>
			  ...
			  <td  width="206" height="50" align="center" valign="middle" style="color:#000000;"><div align="center"><%out.println(s3);%></div></td>
			</tr>
