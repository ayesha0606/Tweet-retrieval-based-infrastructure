...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>  Tweets and Hash Words </span></h2>
          <div class="img"></div>
          <div class="article">
            <p align="justify"> 
	...
	while ( rs.next() )
	{
		...
		%>
		 ...
		 <td  width="109" height="50" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style4">Tweet image </div></td>
				  ...
				  <td   width="206" height="50" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style4">Tweet Description</div></td>
		...
		<td width="109"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=i%>&type=<%="tweet"%>"/></td>
			  ...
			  out.println(s3);%>
			      </div></td><td  width="126" align="center" valign="middle"><div align="center"><%out.println(s4);%></div></td>
			</tr>
